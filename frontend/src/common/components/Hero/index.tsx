...
import { IMedia } from 'src/common/types/Media';
...
const Hero = () => {
  ...
  const renderBackground = (hero: IHeroItem) => {
    const background = hero.background as IMedia;
    if (background.type === 'image') {
      ...
      return (
        ...
        >
          <video autoPlay muted loop style={{ minWidth: '100%', minHeight: '100%' }}>
