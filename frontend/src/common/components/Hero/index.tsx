    ...
    <Box position="relative" overflow="hidden" sx={heroStyle}>
      {backgroundImages.map((item, index) => (
        <Box
          ...
          sx={{
            ...
            background: `url(${fetchImage(`Hero_bg_${slide + 1}.webp`)})`,
      ...
      <Container sx={{ height: '100%' }}>
        <Stack
          ...
          height="100%"
        >
          <Box py={8} display={{ xs: 'block', md: 'none' }} />
          ...
          >
            Our international team is dedicated to providing top-quality
            recording services for artists in the local scene and beyond.
          </Typography>
          <Spacer size={1} />
          <Stack
